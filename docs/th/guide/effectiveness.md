...
SHA-256 นับว่าสมเหตุสมผลในฐานะอัลกอริทึม PoW ทั่วไป แต่ GPU เคลียร์มันได้ต่อวินาทีมากกว่า CPU ราว 150 เท่า คีย์ที่สร้างใหม่จึงใช้ [HashWX](./hashwx.md) เป็นค่าเริ่มต้น ซึ่งช่องว่างเหลือราว 2 เท่า
