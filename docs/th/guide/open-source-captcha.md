...
การป้องกันมาจากสองชั้นที่เป็นอิสระต่อกัน: [proof of work แบบ HashWX](./hashwx.md) ที่ต้านทาน GPU และ [challenge แบบ instrumentation](./instrumentation.md) ที่สร้างใหม่ทุกครั้งเพื่อยืนยันว่าสภาพแวดล้อมเป็นเบราว์เซอร์จริง การเจาะชั้นหนึ่งได้ไม่ได้แปลว่าเจาะอีกชั้นได้
...
| ตัวเลือก PoW ที่ต้าน GPU | ✅ [HashWX](./hashwx.md) | ❌ | ❌ | ❌ |
