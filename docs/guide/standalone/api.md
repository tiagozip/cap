...
| --- | --- | --- | --- |
| `GET /livez` | `200` | — | Confirms the HTTP process can respond and returns server uptime |
| `GET /readyz` | `200` | `500` | Checks if the server is ready to accept traffic and is not shutting down |
