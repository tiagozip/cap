...
- [Best CAPTCHA alternatives in 2026](../best-captcha-alternatives.md): Turnstile, Cap and the rest of the field ranked
- [Bot protection for mobile forms](../mobile-form-bot-protection.md): where fingerprint signals fail hardest
