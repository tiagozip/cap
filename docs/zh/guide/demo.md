---
description: "在线体验 Cap：实时演示这个开源、自托管的 CAPTCHA 验证组件如何在你的浏览器中求解工作量证明质询，无需点选任何视觉谜题。"
---
...
<div class="login-form" style="margin-top: 0.6em;">
  <div class="input" style="border-radius:8px;">
    ...
    <textarea id="comment" rows="3" placeholder="写下你的回复……" style="font-size:16px;padding:.375rem .75rem;padding-top:0;font-family:inherit;background:transparent;border:none;outline:none;resize:vertical;">看起来很棒，感谢分享！</textarea>
  </div>
</div>
...
<p style="font-size: 10px;line-height: 1.3;color: var(--vp-c-text-3);max-width: 300px;user-select: none;">本演示使用的占位服务端不会执行 instrumentation（浏览器环境检测）。</p>
